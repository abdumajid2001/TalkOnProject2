package com.talkon.talkon.talkon.services.user;
...
import com.talkon.talkon.talkon.exceptions.user.UserNotFoundException;
import com.talkon.talkon.talkon.mappers.user.UserMapper;
import com.talkon.talkon.talkon.repositories.user.UserRepository;
import com.talkon.talkon.talkon.services.base.AbstractService;
import com.talkon.talkon.talkon.validators.user.UserValidator;
...
public class UserServiceImp extends AbstractService<UserRepository, UserMapper, UserValidator> implements UserService, UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new com.talkon.talkon.talkon.dtos.user.UserDetails(user);
    }
